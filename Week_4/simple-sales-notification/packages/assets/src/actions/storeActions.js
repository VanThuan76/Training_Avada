...
export const reducer = (state, {type, payload}) => {
  switch (type) {
    ...
    case storeTypes.SET_SETTING:
      return {...state, setting: payload};
    case storeTypes.SET_SAVED:
...
export async function setSetting(dispatch, payload, type = "change") {
  dispatch({type: storeTypes.SET_SETTING, payload: payload});
  type === "change" && dispatch({type: storeTypes.SET_SAVED, payload: true})
}
